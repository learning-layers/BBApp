...
<link href="../assets_ltb/css/child/pages/login-child.css" rel="stylesheet" type="text/css"/>
...
<div class="content">
  ...
  elseif (!isset($_GET['code'])) {
    ...
    ?>
        <!-- BEGIN 'CONNECT TO PODIO' FORM -->
    <form class="login-form" action="<?php echo $auth_url; ?>" method="post">
        <h2 class="form-title"><img src="../assets_ltb/img/ltb-logo.png" height="12%" width="12%">  Datastore</h2>
        ...
        <div class="forget-password">
            <h4>No Podio account ?</h4>
            <p>
                 no worries, click
                <a href="javascript:;" id="forget-password">
                     here
                </a>
                 for help to get you up and running with Podio.
            </p>
        </div>
    </form>
    <!-- END 'CONNECT TO PODIO' FORM -->
    ...
    <!-- <form class="login-form" action="<?php echo $auth_url; ?>" method="post">
        ...
        <div class="form-actions">
            <button type="button" class="btn grey pull-left" disabled>
            Continue
            </button>
        </div>
        <div class="forget-password">
    ...
    </form> -->    <!-- END 'CONNECT TO PODIO' FORM -->
    <!-- BEGIN FORGOT PASSWORD FORM -->
    <form class="forget-form" action="home.html" method="post">
        <h3>Need help ?</h3>
        <p>
    ...
    <form class="register-form" action="home.html" method="post">
        <h3>Sign Up</h3>
        <p>
